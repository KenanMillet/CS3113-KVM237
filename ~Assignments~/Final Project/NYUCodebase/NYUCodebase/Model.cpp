...
Model::Model(const char* texture, Matrix& matrix, Renderer* renderer)
...
Model::Model(std::initializer_list<Vector> vertexColors, std::initializer_list<float> vertexCoords, std::initializer_list<float> textureCoords, Matrix& matrix, Renderer* renderer)
	: Renderable(renderer)
{

}

Model::Model(const char* texture, std::initializer_list<float> vertexCoords, float w, float h, std::initializer_list<float> textureCoords, Matrix& matrix, Renderer* renderer)
...
Model::Model(const char* texture, SpriteSheet* sheet, float sizeX, float sizeY, Matrix& matrix, Renderer* renderer)
	: Renderable(renderer)
{
...
Model::Model(size_t index, UniformSpriteSheet* sheet, float sizeX, float sizeY, Matrix& matrix, Renderer* renderer)
	: Renderable(renderer)
{
	if(sizeY == 0.0f) sizeY = sizeX;
...
Model::Model(const char* texture, const char* sheet, const char* atlas, float sizeX, float sizeY, Matrix& matrix, Renderer* renderer)
	: Renderable(renderer)
{
